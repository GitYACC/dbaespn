...
export default function Basketball(props: SVGProps) {
    return (
        <svg viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg" className={props.className}>
            <title>Basketball</title>
            <defs>
        </defs>
            <g stroke="none" strokeWidth="1" fillRule="evenodd" className={props.fill}>
                <g>
